...
if [ $# -lt 4 ]; then
    ...
    echo "Usage: $0 <model> <conversation-log-directory-name> <persona-setting-directory-name> <model-context-size>"
    echo "Example: $0 mlx-community/Llama-3.2-3B-Instruct-4bit conversations personas 10000"
    exit 1
fi
...
lms server start
lms load $MODEL --context-length=$MODEL_CONTEXT_SIZE --gpu=1.0
